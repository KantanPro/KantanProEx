...
class KTPWP_I18n {
    ...
    private function get_dictionary() {
        ...
        $this->dictionary = array(
            ...
            '編集' => 'Edit',
            '複製' => 'Duplicate',
            '受注書を複製' => 'Duplicate order',
            '受注書を複製しました。' => 'Order duplicated.',
            '複製先の顧客を選んでください。' => 'Choose the client for the duplicate.',
            '複製時の顧客' => 'Client for duplicate',
            'この受注と同じ顧客のまま複製する' => 'Duplicate for the same client',
            '別の顧客を選んで複製する' => 'Duplicate for another client',
            '複製先の顧客' => 'Target client',
            '複製元の受注書 ID が不正です。' => 'Invalid source order ID.',
            '受注書の複製に失敗しました。' => 'Failed to duplicate order.',
            '対象外の顧客には複製できません。' => 'Cannot duplicate for an inactive client.',
            '検索' => 'Search',
            '検索結果' => 'Search results',
            ...
            '宛先' => 'To',
            'CC（任意）' => 'CC (optional)',
            '顧客・部署の連絡先から選べます。' => 'Select from customer or department contacts.',
            '代表メールとは別の部署メールが顧客管理に登録されている場合、ここに選択肢が表示されます。' => 'If department emails different from the primary address are registered in customer management, they will appear here.',
            'その他のCC' => 'Other CC',
            '顧客・部署以外の宛先はカンマまたは改行で入力できます。' => 'Enter addresses outside customer/department contacts separated by commas or line breaks.',
            'BCC（任意）' => 'BCC (optional)',
            '宛先に表示されない控え送信用です。カンマまたは改行で入力できます。' => 'Hidden copy recipients. Enter addresses separated by commas or line breaks.',
            '件名' => 'Subject',
            '本文' => 'Body',
            ...
            '請求残' => 'Outstanding',
            '宛名のご担当' => 'Addressee contact',
            '会社名のみ' => 'Company name only',
            '代表者名を表示' => 'Show representative',
            '部署・ご担当を表示' => 'Show department & contact',
            '※ 本画面の印刷位置は、プリンタの印刷余白が上下左右いずれも10mmのときに長形３号窓明封筒の窓と揃うようレイアウトしています。' => 'Print positions on this screen align with a long No. 3 window envelope when printer margins are 10 mm on all sides.',
            ...
            '対象' => 'Active',
            '対象外' => 'Inactive',
            '公開商品からの問い合わせをブロック' => 'Block public product inquiries',
            'ブロックを解除' => 'Unblock inquiries',
            '公開商品からの問い合わせをブロックしました。' => 'Public product inquiries from this customer are now blocked.',
            '問い合わせブロックを解除しました。' => 'Inquiry block has been removed.',
            '公開商品からの問い合わせをブロック中' => 'Public product inquiries blocked',
            'この顧客のメールアドレスからの公開商品お問い合わせをブロックしますか？' => 'Block public product inquiries from this customer email address?',
            'ブロック設定の更新に失敗しました。' => 'Failed to update block settings.',
            'ブロック機能の DB 更新が未完了です。管理画面を一度開いてから再度お試しください。' => 'The block feature database update is incomplete. Open the admin screen once, then try again.',
            '顧客 ID が取得できません。ページを再読み込みしてください。' => 'Could not determine the customer ID. Please reload the page.',
            '現在、お問い合わせを受け付けておりません。' => 'We are not accepting inquiries at this time.',
            'メールアドレスが未設定のため、ブロックできません。' => 'Cannot block because no email address is set.',
            ' 様' => '',
            '様' => '',
            ...
            'ご担当者名：' => 'Contact:',
            '代表窓口' => 'Representative',
            '請求済（入金予定日超過）' => 'Invoiced (past due date)',
            '（完了日：' => ' (Completion date:',
